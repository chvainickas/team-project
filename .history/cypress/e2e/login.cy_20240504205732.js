describe("Login Form", () => {
  it("successfully logs in with correct credentials", () => {
    cy.visit("http://localhost:3000/login.html"); // Replace 'your_port_number' with your actual port number
  ...
  it("displays an error message for incorrect credentials", () => {
    ...
    // Assert that the login form displays an error message
    // Replace the following line with your specific assertion
    cy.get(".error-message").should("be.visible"); // Replace '.error-message' with the selector for the error message element
  });
});
