describe("Registration Form", () => {
  it("successfully submits the registration form", () => {
    cy.visit("http://localhost:3000/register.html"); // Replace 'your_port_number' with your actual port number
    ...
    cy.url().should("include", "register"); // Replace '/success-page' with the URL of the page after successful registration
  });
});
